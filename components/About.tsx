...
function StatCard({ value, label, delay }: { value: number; label: string; delay: number }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center gap-1 p-6 rounded-2xl border border-[#1e1e1e] bg-[#111111] hover:border-[#c87941]/40 transition-colors duration-300"
    >
      <span className="font-black text-6xl bg-gradient-to-br from-[#c87941] to-[#e8c49a] bg-clip-text text-transparent tabular-nums">
        {count}
      </span>
