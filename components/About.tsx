...
function StatCard({ value, label, delay }: { value: number; label: string; delay: number }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center gap-1 p-6 rounded-2xl border border-[#1e1e1e] bg-[#111111] hover:border-[#C4501C]/40 transition-colors duration-300"
    >
      <span className="font-black text-6xl bg-gradient-to-br from-[#C4501C] to-[#D4903A] bg-clip-text text-transparent tabular-nums">
        {count}
      </span>
