    ...
    >
      ...
      <div
        ...
        style={{
          width: "380px",
          height: "520px",
          background: "radial-gradient(ellipse at 40% 38%, rgba(255,107,107,0.32) 0%, rgba(255,154,154,0.13) 55%, transparent 78%)",
          filter: "blur(52px)",
          top: "6%",
          left: "50%",
      ...
      >
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
          <path d="M11 1 L12.5 9 L20 11 L12.5 13 L11 21 L9.5 13 L2 11 L9.5 9Z" fill="#ff6b6b" opacity="0.85" />
        </svg>
      </motion.div>
      <motion.div
        animate={{ opacity: [0, 1, 0], scale: [0.6, 1.1, 0.6] }}
      ...
      >
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M9 1 L10.2 7.4 L16 9 L10.2 10.6 L9 17 L7.8 10.6 L2 9 L7.8 7.4Z" fill="#ff9a9a" opacity="0.8" />
        </svg>
      </motion.div>
      <motion.div
      ...
      >
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          <circle cx="7" cy="7" r="5" fill="#ff6b6b" opacity="0.4" />
          <circle cx="7" cy="7" r="2.5" fill="#ffe4e4" opacity="0.65" />
        </svg>
      </motion.div>
    </div>
  );
