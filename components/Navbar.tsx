    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          <a
            href="#"
            className="font-black text-xl tracking-tight bg-gradient-to-r from-[#c87941] to-[#e8c49a] bg-clip-text text-transparent"
          >
            Keerthana K R
          </a>
          ...
          <a
            href="/resume.pdf"
            download
            className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-[#c87941] text-white hover:bg-[#d4894e] transition-colors duration-200"
          >
            Download Resume
          </a>
        ...
        {open && (
          ...
          >
            ...
            <a
              href="/resume.pdf"
              download
              className="mt-2 inline-flex w-fit items-center px-4 py-2 rounded-full text-sm font-semibold bg-[#c87941] text-white"
            >
              Download Resume
            </a>
          </motion.div>
