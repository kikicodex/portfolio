          ...
          <div className="lg:max-w-[54%] flex flex-col gap-5">
            ...
            <div style={{ overflow: "hidden" }}>
              <motion.h1
                ...
                className="font-black text-[clamp(1rem,6.5vw,2.5rem)] leading-[1.6] tracking-tight text-[#f5f5f5]/55 whitespace-nowrap"
              >
                Keerthana K R
              </motion.h1>
            </div>
      ...
      >
        <div className="w-full max-w-7xl mx-auto">
          <div className="lg:max-w-[54%] flex flex-wrap gap-4">
            <a
              href="#projects"
              className="px-6 py-3 rounded-none font-semibold text-sm border border-white/50 text-white/70 hover:border-[#E0607A] hover:text-[#E0607A] transition-all duration-200"
            >
              View My Work
            </a>
            <a
